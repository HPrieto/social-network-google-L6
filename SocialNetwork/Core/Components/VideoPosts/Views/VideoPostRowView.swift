...
struct VideoPostRowView: View {
    @ObservedObject var viewModel: VideoPostRowViewModel
    
    init(post: VideoPost) {
        self.viewModel = VideoPostRowViewModel(post: post)
    }
